...
(function(global)
{
  ...
  var CEX = {
    ...
    getPairs: function() {
      this.httpPublicGet("https://cex.io/api/currency_limits").onload = function (e) {
        return JSON.parse(e.target.responseText).data.pairs;
      };
    },
    getPairsOptions: function() {
      this.httpPublicGet("https://cex.io/api/currency_limits").onload = function (e) {
        var pairs = JSON.parse(e.target.responseText).data.pairs;
        var output = [];
    ...
    getTicker: function(pair) {
      this.httpPublicGet("https://cex.io/api/ticker/" + pair).onload = function (e) {
  ...
  function checkCookie() {
      ...
      if (auth !== "1") {
          ...
          if (passphrase !== null && passphrase !== "") {
              ...
              if (decrypted.toString() !== "-1163408929") {
